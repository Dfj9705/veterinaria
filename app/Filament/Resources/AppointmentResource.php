...
class AppointmentResource extends Resource
{
        ...
        return $table
            ...
            ->actions([
                ...
                Tables\Actions\Action::make('start_attention')
                    ...
                    ->color('success')
                    ->visible(fn($record) => !ClinicalRecord::where('appointment_id', $record->id)->exists() && $record->status !== 'Cancelada' && $record->status !== 'No asistió' && (\Illuminate\Support\Facades\Auth::user()->hasRole('Veterinario') || \Illuminate\Support\Facades\Auth::user()->hasRole('Administrador')))
    ...
    {
        return auth()->user()?->can('create_appointments') ?? false;
    }

    public static function canEdit($record): bool
    {
        return auth()->user()?->can('update_appointments') ?? false;
    }
